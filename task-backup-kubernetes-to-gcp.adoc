...
라이센스 요구 사항:: BlueXP 백업 및 복구 PAYGO 라이센스의 경우 를 통한 구독 https://["GCP 마켓플레이스"^] 은 BlueXP 백업 및 복구를 활성화하기 전에 필요합니다. BlueXP 백업 및 복구에 대한 청구는 이 구독을 통해 이루어집니다. https://["작업 환경 마법사의 세부 정보 및 자격 증명 페이지에서 구독할 수 있습니다"^].
+
--
