...
+
--
* Kubernetes 클러스터를 BlueXP 작업 환경으로 발견했습니다. https://docs.netapp.com/us-en/bluexp-kubernetes/task/task-kubernetes-discover-gke.html["Kubernetes 클러스터를 검색하는 방법을 알아보십시오"^].
