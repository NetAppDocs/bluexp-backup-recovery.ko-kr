...
+
** 포트 443을 통해 BlueXP 백업 및 복구 서비스 및 Blob 개체 스토리지에 HTTPS로 연결합니다 (https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-set-up-networking-azure.html#endpoints-contacted-for-day-to-day-operations["끝점 목록을 참조하십시오"^])
...
+
** BlueXP 백업 및 복구 PAYGO 라이센스의 경우 에 가입해야 합니다 https://azuremarketplace.microsoft.com/en-us/marketplace/apps/netapp.cloud-manager?tab=Overview["Azure를 지원합니다"^] BlueXP Marketplace에서 BlueXP 백업 및 복구 사용 BlueXP 백업 및 복구에 대한 청구는 이 구독을 통해 이루어집니다.
