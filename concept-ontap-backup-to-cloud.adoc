...
* SnapLock Compliance 볼륨(ONTAP 9.14 이상 필요)
...
* link:concept-cloud-backup-policies.html#datalock-and-ransomware-protection["DataLock 및 랜섬웨어 방어의 작동 방식"].
* link:manage-backup-settings-ontap.html["고급 설정 페이지에서 랜섬웨어 보호 옵션을 업데이트하는 방법"].
