...
[role="quick-margin-para"]
선택적으로 기본 Google Cloud 암호화 키를 사용하는 대신 데이터 암호화에 대해 사용자 지정 관리 키를 설정할 수 있습니다. <<Prepare Google Cloud storage as your backup target,Google Cloud 환경에서 ONTAP 백업을 받을 수 있는 방법에 대해 알아보십시오.>>
