...
* 온-프레미스 클러스터를 발견하고 BlueXP에서 작업 환경으로 추가했습니다. 을 참조하십시오 https://docs.netapp.com/us-en/bluexp-ontap-onprem/task-discovering-ontap.html["ONTAP 클러스터 검색"^] 를 참조하십시오.
+
...
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-google.html["GCP에 커넥터 설치"^]
