...
BlueXP  백업 및 복구 UI에서 오브젝트 스토리지 정책에 대한 스냅샷, 복제, 백업을 생성할 수 있습니다. 자세한 내용은 섹션을 link:task-manage-backups-ontap.html#add-a-new-backup-to-cloud-policy["새 백업 정책 추가"]참조하십시오.
