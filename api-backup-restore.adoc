...
여기서는 Cloud Central 계정 ID "account-DpTFcxN3", BlueXP 커넥터 ID "iZwFFeVCZjWnzGlw8RgD0QNANZvpP7IClients" 및 사용자 토큰 "BEARER UJHbGciOiJSUZSUZSUI1NiSXinSXI5XIMUCJUCJUCJUXUXUXYUXUXUXUXUXUXYUXYUXYUXYUXUXUXUXUXYUC4C4CJUXYUXYUXYUXYUXYUXYUXUXUXYUXYU
