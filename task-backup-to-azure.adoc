...
* Azure에 커넥터가 설치되어 있습니다. 커넥터는 전체 인터넷 액세스("표준 모드")가 있는 사이트나 제한된 인터넷 연결("제한 모드")으로 설치할 수 있습니다. .image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png["2개"] 새로운 시스템이나 기존 시스템에서 Cloud Backup을 활성화합니다
...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-creating-connectors-azure.html["Azure에 커넥터를 배포합니다"^]
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-install-connector-onprem-no-internet.html["Azure 지역의 Linux 호스트에 수동으로 커넥터 설치"^]
