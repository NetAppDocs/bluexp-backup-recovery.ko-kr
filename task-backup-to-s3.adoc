...
커넥터 요구 사항:: 커넥터는 전체 또는 제한된 인터넷 액세스("표준" 또는 "제한" 모드)가 있는 AWS 지역에 설치할 수 있습니다.
+
--
...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-install-restricted-mode.html["AWS 지역의 Linux 호스트에 수동으로 커넥터 설치"^]
