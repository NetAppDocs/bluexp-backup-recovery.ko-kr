...
[role="lead"]
SnapCenter Plug-in for VMware vSphere와 BlueXP를 통합하여 하나 이상의 데이터 저장소를 Amazon 웹 서비스에 백업할 수 있습니다. VM 관리자는 이를 통해 스토리지 효율성을 위해 데이터를 쉽고 빠르게 백업 및 아카이브하고 클라우드 전환을 가속화할 수 있습니다.
